...
<div class="input__container input__container--variant">
        ...
        <form method="post">
            <input type="text" name="city" class="input__search input__search--variant" placeholder="Search City...">
    ...
    <tbody id="analysisData">
        ...
        if(isset($_POST['submit'])) {
            $city = $_POST['city'];
            // Sanitize $city to prevent SQL injection

            $crime_query = "SELECT * FROM Crime WHERE City = '$city'";
            ...
            while($crime_row = mysqli_fetch_assoc($crime_result)) {
                ...
                if ($location_row = mysqli_fetch_assoc($location_result)) {
                    ...
                    echo "<td colspan='4'>No location data available</td>";
                }
